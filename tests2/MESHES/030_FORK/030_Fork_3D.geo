...
Physical Volume("ROCK_A") = {3};
Physical Volume("ROCK_B") = {1};
Physical Volume("ROCK_C") = {2};

Physical Surface(".A")     = {271}; // Left
Physical Surface(".B")     = {217}; // Right-Top
Physical Surface(".C")     = {244}; // Right-Bottom
